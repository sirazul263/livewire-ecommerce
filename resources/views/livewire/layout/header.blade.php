                            ...
                            <ul>
                                @auth
                                    <li>
                                        ...
                                        <button type="button" class="bg-transparent border-0" wire:click="logout">Log Out
                                        </button> /
                                ...
                                @else
                                    <li><i class="fi-rs-key"></i><a href="/login" wire:navigate>Log In </a> / <a
                                            href="/register" wire:navigate>Sign Up</a></li>
                                @endauth
                                    ...
                                    <li><a href="#">My Account<i class="fi-rs-angle-down"></i></a>
                                        @auth
                                            @if (Auth::user()->user_type == 'admin')
                                                <ul class="sub-menu">
                                                    <li><a href="/admin/dashboard" wire:navigate>Amin Dashboard</a></li>
                                            ...
                                            @else
                                                <ul class="sub-menu">
                                                    <li><a href="/user/dashboard" wire:navigate>Dashboard</a></li>
                                                    <li><a href="#">Orders</a></li>
                                                    <li><a href="#">Logout</a></li>
                                                </ul>
                                            @endif
